    ...
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {VEHICLES_DATA.map((v) => {
          ...
          return (
            <div
              key={v.id}
              className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between"
            >
              <div>
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 sm:p-8 space-y-6">
        <div className="text-center space-y-1">
          ...
          <h2 className="text-2xl font-black text-slate-900">Why Hire Private Cars from Jahangir Khan?</h2>
        </div>
